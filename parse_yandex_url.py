...
def get_yandex_reviews(restaurant_url):
    ...
    # rate_string = ''
    # rate_container = soup.find('div', {'class': 'card-reviews-view__summary'}).div
    # print(rate_container)
    # for rate_part in rate_container:
    #     rate_string += rate_part.text
    # print(rate_string)
    ...
    for i, item in enumerate(items):
        ...
        review = {'index': i, 'reviewer_name': reviewer_name, 'review_rate': review_rate_number, 'review_text': review_text}
